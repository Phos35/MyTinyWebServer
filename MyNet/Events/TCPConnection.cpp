...
{
    LOG_TRACE << "TCPConnection " << id_ << " Deconstruct";
}
...
{   
    ...
    Timestamp closeTime = Timestamp::now().addMillisec(30000);
    ...
    LOG_TRACE << "New Connection " << id_ << " Established, fd: " << peer_.fd()
...
void TCPConnection::destroy()
{
    ...
    LOG_TRACE << "Connection " << id_ << " Destroyed, fd " << peer_.fd();
